...
namespace App\CustomVendor\Providers;

use App\CustomVendor\JWTAuth;
...
class JWTAuthServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app['App\CustomVendor\JWTAuth'] = function ($app) {
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../../../vendor/tymon/jwt-auth/src/config/config.php', 'jwt');
