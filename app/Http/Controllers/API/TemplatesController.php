...
class TemplatesController extends Controller
{
    ...
    //     $header = !empty($user_info->avatar['origin'])
    //                 ? '<div class="image-avatar"><img style="width:100%;" id="image" src="' . asset($user_info->avatar['origin']) . '"></div>'
    //                 : '<div class="image-avatar"><img style="width:100%;" id="image" src="' . asset('images/avatar.jpg') . '"></div>';
    ...
    //                 </div>
    //                 <div class="box"><span>' . $user_info->infomation . '<span></div>
    //             </div>';
    ...
    //                         <span>Skills</span>
    //                     </div>
    //                     <div class="box">' . implode('', $skills) . ' </div>
    //                 </div>';
    ...
    //                     </div>
    //                     <div class="box">' . implode('', $references) . '</div>
    //                 </div>';
    ...
    //                         <span>objectives</span>
    //                     </div>
    //                     <div class="box">' . implode('', $objectives) . '</div>
    //                 </div>';
    //     $template = [
    //         "header" => $header,
    //         "info" => $info,
    ...
    public function postBasicTemplate(Request $request)
    {
        ...
        $templates->user_id = $user_info->id;
        $templates->title = "Basic Template";
        $templates->template_full = $template_html;
        if ($templates->save()) {
            return response()->json([
                "status_code" => 200,
                "status" => true,
